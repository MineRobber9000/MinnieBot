...
class AdminCog(Cog, name="Admin"):
	...
	async def load(self,ctx,*,ext):
		if ext in self.bot.extensions:
			await ctx.send("That extension is already loaded, dummy!")
			return
	...
	async def unload(self,ctx,*,ext):
		if ext not in self.bot.extensions:
			await ctx.send("That extension isn't loaded, dummy!")
			return
	...
	@command("eval",brief="Evaluate Python code. Only minerobber can do this.")
	@is_owner()
